...
public class ReducedUserProfile implements Serializable, Writable {
     ...
     */
    private short maxNumFriends;
    /**
     * < @brief The maximum number of friends the user can have.*
     */
    private short numFriends;
    /**
     * < @brief The number of friends the user has.*
     */
    private byte numCorDimensions;
    /**
     * < @brief The number of correlation dimensions.*
     */
    private short corMaxNumFriends[];
    /**
     * < @brief The number of maximum friends per correlation dimension.*
     */
    private short corNumFriends[];
    /**
     * < @brief The number of friends added per correlation dimension.*
     */
    private Friend friendList[];
    /**
     * < @brief The list of friends.*
     */
    private TreeSet<Long> friendIds;
    /**
     * < @brief The set of friends' ids.*
     */
     ...
     */
    private boolean isHaveSmartPhone;
    /**
     * < @brief Used to know whether the user has a smartphone or not.*
     */
    private int agentId;
    /**
     * < @brief Index of user agent in the dictionary, e.g., 0 for iPhone, 1 for HTC *
     */
     ...
     * For IP address *
     */
    private boolean isFrequentChange;
    /**
     * < @brief About 1% of users frequently change their location.*
     */
    ...
    /**
     * < @brief The home country of the user.*
     */
    private int cityId;
    /**
     * < @brief The city identifier of the country of the user the user lives in. *
     */
    private long wallId;
    /**
     * < @brief The id of the group represeting the wall of the user.*
     */
    private TreeSet<Integer> interests;
    /**
     * < @brief The set of interests of the user.*
     */
    private int mainInterest;
    /**
     * < @brief The main user interest.
     */

    private short popularPlaceIds[];
    /**
     * < @brief The set of popular places the user visits.*
     */
    ...
    /**
     * < @brief The university location id where the user studied.*
     */
    private byte gender;
    /**
    ...
    /**
     * < @brief The birthday of the user.*
     */
    ...
    /**
     * < @brief Specifies whether the user is a large poster or not.
     */
