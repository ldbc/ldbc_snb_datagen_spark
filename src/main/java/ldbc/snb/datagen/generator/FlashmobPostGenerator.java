...
public class FlashmobPostGenerator extends PostGenerator {
    ...
    /**
     * < @brief The flashmobTagDictionary used to get the tags of the posts.
     */
...
//        this.postPerLevelScaleFactor = postPerLevelScaleFactor;
    ...
    protected int generateNumOfPost(Random randomNumPost, ReducedUserProfile user) {
        ArrayList<FlashmobTag> temp = flashmobTagDictionary.generateFlashmobTags(user.getInterests(), user.getCreationDate());
    ...
    protected int generateNumOfPost(Random randomNumPost, Forum forum) {
        ...
        ArrayList<FlashmobTag> temp = flashmobTagDictionary.generateFlashmobTags(tags, forum.getCreatedDate());
