...
public class PhotoGenerator {
    ...
    public Photo generatePhoto(ReducedUserProfile user, Forum album,
        ...
        if (numPopularPlace == 0) {
            locationName = locationDic.getPlaceName(locationId);
...
//        }
        ...
        Photo photo = new Photo(SN.composeId(photoId, date), "photo" + SN.composeId(photoId, date) + ".jpg", 0, date, album.getModeratorId(), album.getForumId(), tags, null, new String(""), (byte) -1, locationId, locationName, latt, longt);
