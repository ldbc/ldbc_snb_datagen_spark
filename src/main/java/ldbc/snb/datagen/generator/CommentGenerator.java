...
public class CommentGenerator {
    ...
    private int minSizeOfComment;
    /**
     * < @brief The minimum size of a comment.
     */
    private int maxSizeOfComment;
    /**
     * < @brief The maximum size of a comment.
     */
    private int minLargeSizeOfComment;
    /**
     * < @brief The minimum size of large comments.
     */
    private int maxLargeSizeOfComment;
    /**
     * < @brief The maximum size of large comments.
     */
    private double largeCommentRatio;
    /**
     * < @brief The ratio of large comments.
     */
    private boolean generateText;
    /**
     * < @brief To generate the text of comments.
     */
    private int maxNumberOfLikes;
    private long deltaTime;
    /**
     * < @brief The minimum time to span between post creation and its reply.
     */
    ...
    public Comment createComment(RandomGeneratorFarm randomFarm, long commentId, Post post, Message replyTo, Forum forum) {

        ArrayList<Integer> validIds = new ArrayList<Integer>();
        ForumMembership[] memberShips = forum.getMemberShips();
        for (int i = 0; i < forum.getNumMemberAdded(); i++) {
        ...
        ForumMembership membership = forum.getMemberShips()[validIds.get(memberIdx)];
        ...
        if (!isShort && randomFarm.get(RandomGeneratorFarm.Aspect.NUM_LIKE).nextDouble() <= 0.1) {
            setLikes(randomFarm.get(RandomGeneratorFarm.Aspect.NUM_LIKE), randomFarm.get(RandomGeneratorFarm.Aspect.DATE), comment, forum);
        }
        return comment;
    }
}
