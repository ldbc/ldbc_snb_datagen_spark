    ...
    public static class HadoopFileRankerSortReducer<K, V, T extends ComposedKey>  extends Reducer<K, V, ComposedKey, V> {
        ...
        public void cleanup(Context context) {
            ...
            try {
                ...
                DataOutputStream output = fs.create(new Path(conf.get("outputDir")+"/hadoop/rank_"+reducerId));
        ...
        public void setup( Context context ) {
            ...
            try{
                ...
                for(int i = 0; i < (numReduceTasks-1); ++i ) {
                    DataInputStream inputFile = fs.open(new Path(conf.get("outputDir")+"/hadoop/rank_"+i));
