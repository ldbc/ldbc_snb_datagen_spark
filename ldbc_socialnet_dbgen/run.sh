#!/bin/bash
HADOOP_HOME=/home/aprat/hadoop-1.2.1 #change to your hadoop folder
LDBC_SOCIALNET_DBGEN_HOME=/scratch/aprat/generador/ldbc_socialnet_bm/ldbc_socialnet_dbgen #change to your ldbc_socialnet_dbgen folder 
NUM_MACHINES=4 #the number of threads to use.
OUTPUT_DIR=/scratch/aprat/generador #change to the folder where the generated data should be written
...
/usr/local/apache-maven-3.1.0/bin/mvn clean
/usr/local/apache-maven-3.1.0/bin/mvn assembly:assembly
