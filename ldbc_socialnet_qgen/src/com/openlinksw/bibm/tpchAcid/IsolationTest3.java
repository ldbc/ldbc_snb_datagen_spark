...
class IsolationTest3 extends AcidTest implements Runnable {
        TransactionParams params1;
        AcidTransaction txn2;
        SQLException txn2Exception;

        IsolationTest3(TestDriver driver) {
            super(driver);
        }
         ...
         * update transactions when the first transaction is committed. FIXME:
        ...
        public String runTest() throws SQLException, InterruptedException {
            ...
            if (!txn2.l_extendedPrice.equals(txn1.new_extprice)) {
                return "comparison failed: " + txn2.l_extendedPrice.toPlainString() + " != " + txn1.new_extprice.toPlainString();
            }
